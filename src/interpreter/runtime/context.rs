...
impl<'a> ExecutionContext<'a> {
    ...
    pub fn ir_goal_to_runtime(
        &mut self,
        ir_goal: &crate::interpreter::ir::Goal,
        ...
        let result = match ir_goal {
            ...
            crate::interpreter::ir::Goal::Fresh(fresh) => self.ir_fresh_to_runtime(fresh),
            crate::interpreter::ir::Goal::Let(let_binding) => self.ir_let_to_runtime(let_binding),
    ...
    pub fn ir_term_to_runtime(
        &mut self,
        ir_term: &crate::interpreter::ir::Term,
        ...
        match ir_term {
            ...
            crate::interpreter::ir::Term::Literal(literal) => self.ir_literal_to_runtime(literal),
            crate::interpreter::ir::Term::List(list) => self.ir_list_to_runtime(list),
    ...
    fn ir_literal_to_runtime(
        &self,
        ir_literal: &crate::interpreter::ir::Literal,
    ) -> Result<LTerm, CompileError> {
        match ir_literal {
    ...
    fn ir_list_to_runtime(
        &mut self,
        list: &crate::interpreter::ir::List,
    ) -> Result<LTerm, CompileError> {
    ...
    fn ir_struct_to_runtime(
        &mut self,
        struct_construction: &crate::interpreter::ir::StructConstruction,
    ) -> Result<LTerm, CompileError> {
    ...
    fn ir_enum_variant_to_runtime(
        &mut self,
        enum_construction: &crate::interpreter::ir::EnumVariantConstruction,
    ) -> Result<LTerm, CompileError> {
    ...
    fn ir_predicate_call_to_runtime(
        &mut self,
        predicate_call: &crate::interpreter::ir::PredicateCall,
    ) -> Result<Goal, CompileError> {
    ...
    fn ir_fresh_to_runtime(
        &mut self,
        fresh: &crate::interpreter::ir::Fresh,
    ) -> Result<Goal, CompileError> {
        // Push new scope
        self.push_scope();
    ...
    fn ir_let_to_runtime(
        &mut self,
        let_binding: &crate::interpreter::ir::Let,
    ) -> Result<Goal, CompileError> {
        // Push new scope
        self.push_scope();
    ...
    fn ir_pattern_match_to_runtime(
        &mut self,
        pattern_match: &crate::interpreter::ir::PatternMatch,
    ) -> Result<Goal, CompileError> {
    ...
    fn ir_constraint_to_runtime(
        &mut self,
        constraint_block: &crate::interpreter::ir::ConstraintBlock,
    ) -> Result<Goal, CompileError> {
    ...
    fn ir_predicate_to_runtime(
        &mut self,
        predicate: &crate::interpreter::ir::Predicate,
        args: Vec<LTerm>,
    ) -> Result<Goal, CompileError> {
    ...
    fn compile_pattern(
        &mut self,
        pattern: &crate::interpreter::ir::Pattern,
        term: LTerm,
    ) -> Result<Goal, CompileError> {
        match pattern {
    ...
    fn compile_list_pattern(
        &mut self,
        list_pattern: &crate::interpreter::ir::ListPattern,
        term: LTerm,
    ) -> Result<Goal, CompileError> {
    ...
    fn compile_struct_pattern(
        &mut self,
        struct_pattern: &crate::interpreter::ir::StructPattern,
        term: LTerm,
    ) -> Result<Goal, CompileError> {
        let mut goals = Vec::new();
    ...
    fn compile_enum_variant_pattern(
        &mut self,
        enum_pattern: &crate::interpreter::ir::EnumVariantPattern,
        term: LTerm,
    ) -> Result<Goal, CompileError> {
        let mut goals = Vec::new();
